...
namespace eSyaPatientManagement.DL.Entities
{
    public partial class eSyaEnterpriseContext : DbContext
    {
        ...
        public virtual DbSet<GtEcapms> GtEcapms { get; set; }
        ...
        public virtual DbSet<GtEcpapc> GtEcpapc { get; set; }
        public virtual DbSet<GtEcptcb> GtEcptcb { get; set; }
        public virtual DbSet<GtEcptcc> GtEcptcc { get; set; }
        public virtual DbSet<GtEcptcd> GtEcptcd { get; set; }
        public virtual DbSet<GtEcptch> GtEcptch { get; set; }
        public virtual DbSet<GtEcptcr> GtEcptcr { get; set; }
        public virtual DbSet<GtEcptdp> GtEcptdp { get; set; }
        public virtual DbSet<GtEcptsp> GtEcptsp { get; set; }
        public virtual DbSet<GtEcptsr> GtEcptsr { get; set; }
        ...
        public virtual DbSet<GtEfoppc> GtEfoppc { get; set; }
        ...
        public virtual DbSet<GtEforvl> GtEforvl { get; set; }
        ...
        public virtual DbSet<GtEfpbsd> GtEfpbsd { get; set; }
        public virtual DbSet<GtEfpbsh> GtEfpbsh { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<GtEcapms>(entity =>
            {
                entity.HasKey(e => new { e.BusinessKey, e.ApprovalType, e.KeyReference, e.SerialNumber });

                entity.ToTable("GT_ECAPMS");

                entity.Property(e => e.ApprovalType)
                    .HasMaxLength(4)
                    .IsUnicode(false);

                entity.Property(e => e.ApprovalRangeFrom).HasColumnType("decimal(18, 0)");

                entity.Property(e => e.ApprovalRangeTo).HasColumnType("decimal(18, 0)");
            ...
            {
                entity.HasKey(e => new { e.BusinessKey, e.PatientTypeId, e.PatientCategoryId, e.CareCardNumber });
                ...
                entity.Property(e => e.CareCardIdpattern)
                    .IsRequired()
                    .HasColumnName("CareCardIDPattern")
                    .HasMaxLength(10);
            ...
            {
                entity.HasKey(e => new { e.BusinessKey, e.PatientTypeId, e.PatientCategoryId, e.DocumentId });
            ...
            modelBuilder.Entity<GtEcptcr>(entity =>
            {
                entity.HasKey(e => new { e.BusinessKey, e.PatientTypeId, e.PatientCategoryId, e.CurrencyCode, e.EffectiveFrom });

                entity.ToTable("GT_ECPTCR");
            ...
            modelBuilder.Entity<GtEfoppc>(entity =>
            {
                entity.HasKey(e => new { e.BusinessKey, e.RUhid, e.Opnumber });

                entity.ToTable("GT_EFOPPC");
                ...
                entity.HasOne(d => d.GtEfopvd)
                    .WithOne(p => p.GtEfoppc)
                    .HasForeignKey<GtEfoppc>(d => new { d.BusinessKey, d.RUhid, d.Opnumber })
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_GT_EFOPPC_GT_EFOPVD");
            });
            ...
            modelBuilder.Entity<GtEfoppp>(entity =>
            {
                ...
                entity.HasOne(d => d.RUh)
                    .WithMany(p => p.GtEfoppp)
                    .HasForeignKey(d => d.RUhid)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_GT_EFOPPP_GT_EFOPPR");
            });
            ...
            modelBuilder.Entity<GtEforvl>(entity =>
            {
                entity.HasKey(e => e.RegnType);

                entity.ToTable("GT_EFORVL");
            ...
            modelBuilder.Entity<GtEfpbsd>(entity =>
            {
                entity.HasKey(e => new { e.BusinessKey, e.SuspendBillKey, e.SerialNumber });

                entity.ToTable("GT_EFPBSD");
            ...
            modelBuilder.Entity<GtEfpbsh>(entity =>
            {
                entity.HasKey(e => new { e.BusinessKey, e.FinancialYear, e.DocumentId, e.DocumentNumber });

                entity.ToTable("GT_EFPBSH");
